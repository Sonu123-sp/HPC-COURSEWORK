...
/****************************************************************************
  ...
  Compile and run with:
    nvcc -o passwordcrackwith2initial_cuda  passwordcrackwith2initial_cuda.cu 
...
__device__ int is_a_match(char *attempt) {
	char plain_password1[] = "SO19";
	char plain_password2[] = "NU40";
	char plain_password3[] = "CH57";
	char plain_password4[] = "AN45";
